...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".modal-body{padding:20px}.modal-body .form-label{font-size:12px;font-weight:600;margin-bottom:4px}.jump-chain{display:flex;align-items:center;gap:8px;padding:8px 10px;border:1px solid rgba(255,255,255,.14);border-radius:6px;background:var(--bs-secondary-bg);font-size:12px;color:var(--bs-secondary)}.jump-chain span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.jump-chain i{font-size:11px;color:var(--bs-primary);flex-shrink:0}", "",{"version":3,"sources":["webpack://./src/components/hostEditor.component.scss"],"names":[],"mappings":"AAAA,YACI,YAAA,CAEA,wBACI,cAAA,CACA,eAAA,CACA,iBAAA","sourcesContent":[".modal-body {\r\n    padding: 20px;\r\n\r\n    .form-label {\r\n        font-size: 12px;\r\n        font-weight: 600;\r\n        margin-bottom: 4px;\r\n    }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":host{display:flex;flex-direction:column;height:100%;overflow:hidden;background:var(--bs-body-bg)}.me-layout{display:flex;flex-direction:column;height:100%;overflow:hidden;position:relative}.me-layout--drag-over{outline:2px dashed var(--bs-primary);outline-offset:-3px}.me-drag-overlay{position:absolute;inset:0;z-index:100;display:flex;align-items:center;justify-content:center;background:rgba(var(--bs-primary-rgb), 0.15);border:2px dashed var(--bs-primary);font-size:1.1rem;font-weight:600;color:var(--bs-primary);pointer-events:none}.me-drop-hint{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--bs-secondary);font-size:.85rem;gap:4px;border:2px dashed rgba(255,255,255,.12);margin:12px;border-radius:8px}.me-loading{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--bs-secondary)}.me-panes{flex:1;display:grid;gap:3px;overflow:hidden;background:#000;min-height:0;align-items:stretch;align-content:stretch}.me-pane{display:flex;flex-direction:column;overflow:hidden;min-height:0;border-top:3px solid rgba(255,255,255,.1);transition:border-top-color .15s}.me-pane--active{border-top-color:var(--bs-primary)}.me-pane--drag-over{border-top-color:var(--bs-warning);outline:1px dashed var(--bs-warning)}.me-pane-header{display:flex;align-items:center;gap:5px;padding:2px 6px;background:rgba(255,255,255,.05);font-size:.7rem;color:var(--bs-secondary);flex-shrink:0;cursor:grab}.me-pane-header:active{cursor:grabbing}.me-pane-header i{font-size:.65rem}.me-pane-title{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.me-pane-close{background:none;border:none;color:var(--bs-secondary);cursor:pointer;padding:0 2px;font-size:.65rem;line-height:1;opacity:.5}.me-pane-close:hover{opacity:1;color:var(--bs-danger)}.me-pane-body{display:none}.me-pane ::ng-deep ssh-tab,.me-pane ::ng-deep telnet-tab,.me-pane ::ng-deep serial-tab,.me-pane ::ng-deep base-terminal-tab,.me-pane ::ng-deep [class*=-tab]{flex:1;min-height:0;overflow:hidden;display:flex;flex-direction:column}.me-pane ::ng-deep .content{flex:1;min-height:0;overflow:hidden}.me-pane ::ng-deep terminal-toolbar{flex-shrink:0}.me-pane ::ng-deep .terminal-toolbar-spacer{display:none}.me-cmdbar{flex-shrink:0;border-top:1px solid rgba(255,255,255,.1);background:var(--bs-body-bg);padding:8px 12px;display:flex;flex-direction:column;gap:7px}.me-cmdbar-top{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.me-cmdbar-label{font-size:.75rem;font-weight:700;color:var(--bs-secondary);text-transform:uppercase;letter-spacing:.04em;white-space:nowrap;flex-shrink:0}.me-chips{display:flex;flex-wrap:wrap;gap:4px;flex:1}.me-chip-wrap{display:inline-flex;align-items:center}.me-chip-wrap:hover .me-chip-remove{opacity:1;width:18px;margin-left:1px}.me-chip-remove{background:none;border:none;color:var(--bs-secondary);cursor:pointer;padding:0;font-size:.55rem;line-height:1;opacity:0;width:0;overflow:hidden;transition:opacity .15s,width .15s}.me-chip-remove:hover{color:var(--bs-danger)}.me-chip{display:inline-flex;align-items:center;gap:4px;padding:3px 9px;border-radius:100px;font-size:.75rem;font-weight:600;border:1px solid rgba(255,255,255,.15);background:var(--bs-secondary-bg);color:var(--bs-secondary);cursor:pointer;transition:all .15s;-webkit-user-select:none;user-select:none}.me-chip i{font-size:.6rem}.me-chip--on{border-color:var(--bs-primary);background:rgba(var(--bs-primary-rgb), 0.18);color:var(--bs-body-color)}.me-chip:hover:not(.me-chip--on){border-color:rgba(255,255,255,.35);color:var(--bs-body-color)}.me-addhost-wrap{position:relative;flex-shrink:0}.me-addhost-input-wrap{display:flex;align-items:center;gap:5px;background:var(--bs-secondary-bg);border:1px solid rgba(255,255,255,.15);border-radius:4px;padding:2px 7px;transition:border-color .15s}.me-addhost-input-wrap:focus-within{border-color:var(--bs-primary)}.me-addhost-icon{font-size:.65rem;color:var(--bs-secondary);flex-shrink:0}.me-addhost-input{background:none;border:none;outline:none;color:var(--bs-body-color);font-size:.72rem;font-weight:600;width:90px;min-width:0}.me-addhost-input::placeholder{color:var(--bs-secondary)}.me-addhost-clear{font-size:.6rem;color:var(--bs-secondary);cursor:pointer;flex-shrink:0;transition:color .1s}.me-addhost-clear:hover{color:var(--bs-body-color)}.me-addhost-results{position:absolute;bottom:calc(100% + 6px);right:0;min-width:210px;max-height:240px;overflow-y:auto;background:var(--bs-body-bg);border:1px solid rgba(255,255,255,.15);border-radius:6px;box-shadow:0 -6px 20px rgba(0,0,0,.45);z-index:200;padding:4px 0}.me-addhost-item{display:flex;align-items:center;width:100%;padding:5px 12px;background:none;border:none;color:var(--bs-body-color);font-size:.8rem;text-align:left;cursor:pointer;transition:background .1s,color .1s;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.me-addhost-item:hover,.me-addhost-item--active{background:rgba(var(--bs-primary-rgb), 0.15);color:var(--bs-primary)}.me-addhost-empty{padding:6px 12px;font-size:.75rem;color:var(--bs-secondary)}.me-btn{padding:2px 9px;border-radius:4px;font-size:.72rem;font-weight:600;border:1px solid rgba(255,255,255,.15);background:var(--bs-secondary-bg);color:var(--bs-secondary);cursor:pointer;white-space:nowrap;transition:all .15s}.me-btn:hover{background:var(--bs-primary);border-color:var(--bs-primary);color:#fff}.me-broadcast-row{display:flex;align-items:center;gap:7px;padding:5px 10px;border-radius:5px;border:1px solid rgba(255,255,255,.12);background:var(--bs-secondary-bg);color:var(--bs-secondary);font-size:.78rem;cursor:text;outline:none;transition:border-color .15s,background .15s;-webkit-user-select:none;user-select:none}.me-broadcast-row:focus,.me-broadcast-row--active{border-color:var(--bs-primary);background:rgba(var(--bs-primary-rgb), 0.08);color:var(--bs-body-color)}.me-broadcast-row--empty{opacity:.5;cursor:default}.me-broadcast-icon{font-size:.72rem;flex-shrink:0}.me-broadcast-hint{font-style:italic}.me-broadcast-typing{display:flex;align-items:center;gap:4px;color:var(--bs-primary);font-weight:600}.me-broadcast-cursor{animation:me-blink 1s step-end infinite}@keyframes me-blink{0%,100%{opacity:1}50%{opacity:0}}", "",{"version":3,"sources":["webpack://./src/components/multiExecTab.component.scss"],"names":[],"mappings":"AAAA,MACI,YAAA,CACA,qBAAA,CACA,WAAA,CACA,eAAA,CACA,4BAAA,CAIJ,WACI,YAAA,CACA,qBAAA,CACA,WAAA,CACA,eAAA,CACA,iBAAA,CAIJ,sBACI,oCAAA,CACA,mBAAA,CAIJ,iBACI,iBAAA,CACA,OAAA,CACA,WAAA,CACA,YAAA,CACA,kBAAA,CACA,sBAAA,CACA,4CAAA,CACA,mCAAA,CACA,gBAAA,CACA,eAAA,CACA,uBAAA,CACA,mBAAA,CAIJ,cACI,MAAA,CACA,YAAA,CACA,qBAAA,CACA,kBAAA,CACA,sBAAA,CACA,yBAAA,CACA,gBAAA,CACA,OAAA,CACA,uCAAA,CACA,WAAA,CACA,iBAAA,CAIJ,YACI,MAAA,CACA,YAAA,CACA,qBAAA,CACA,kBAAA,CACA,sBAAA,CACA,yBAAA,CAIJ,UACI,MAAA,CACA,YAAA,CACA,OAAA,CACA,eAAA,CACA,eAAA,CACA,YAAA,CACA,mBAAA,CACA,qBAAA,CAGJ,SACI,YAAA,CACA,qBAAA,CACA,eAAA,CACA,YAAA,CACA,yCAAA,CACA,gCAAA,CAEA,iBACI,kCAAA,CAGJ,oBACI,kCAAA,CACA,oCAAA,CAIR,gBACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,eAAA,CACA,gCAAA,CACA,eAAA,CACA,yBAAA,CACA,aAAA,CACA,WAAA,CAEA,uBAAA,eAAA,CAEA,kBAAA,gBAAA,CAGJ,eACI,MAAA,CACA,eAAA,CACA,sBAAA,CACA,kBAAA,CAGJ,eACI,eAAA,CACA,WAAA,CACA,yBAAA,CACA,cAAA,CACA,aAAA,CACA,gBAAA,CACA,aAAA,CACA,UAAA,CAEA,qBAAA,SAAA,CAAA,sBAAA,CAIJ,cACI,YAAA,CAKJ,6JAKI,MAAA,CACA,YAAA,CACA,eAAA,CACA,YAAA,CACA,qBAAA,CAIJ,4BACI,MAAA,CACA,YAAA,CACA,eAAA,CAGJ,oCACI,aAAA,CAGJ,4CACI,YAAA,CAIJ,WACI,aAAA,CACA,yCAAA,CACA,4BAAA,CACA,gBAAA,CACA,YAAA,CACA,qBAAA,CACA,OAAA,CAGJ,eACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,cAAA,CAGJ,iBACI,gBAAA,CACA,eAAA,CACA,yBAAA,CACA,wBAAA,CACA,oBAAA,CACA,kBAAA,CACA,aAAA,CAGJ,UACI,YAAA,CACA,cAAA,CACA,OAAA,CACA,MAAA,CAGJ,cACI,mBAAA,CACA,kBAAA,CAEA,oCACI,SAAA,CACA,UAAA,CACA,eAAA,CAIR,gBACI,eAAA,CACA,WAAA,CACA,yBAAA,CACA,cAAA,CACA,SAAA,CACA,gBAAA,CACA,aAAA,CACA,SAAA,CACA,OAAA,CACA,eAAA,CACA,kCAAA,CAEA,sBAAA,sBAAA,CAGJ,SACI,mBAAA,CACA,kBAAA,CACA,OAAA,CACA,eAAA,CACA,mBAAA,CACA,gBAAA,CACA,eAAA,CACA,sCAAA,CACA,iCAAA,CACA,yBAAA,CACA,cAAA,CACA,mBAAA,CACA,wBAAA,CACA,gBAAA,CAEA,WAAA,eAAA,CAEA,aACI,8BAAA,CACA,4CAAA,CACA,0BAAA,CAGJ,iCACI,kCAAA,CACA,0BAAA,CAKR,iBACI,iBAAA,CACA,aAAA,CAGJ,uBACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,iCAAA,CACA,sCAAA,CACA,iBAAA,CACA,eAAA,CACA,4BAAA,CAEA,oCACI,8BAAA,CAIR,iBACI,gBAAA,CACA,yBAAA,CACA,aAAA,CAGJ,kBACI,eAAA,CACA,WAAA,CACA,YAAA,CACA,0BAAA,CACA,gBAAA,CACA,eAAA,CACA,UAAA,CACA,WAAA,CAEA,+BAAA,yBAAA,CAGJ,kBACI,eAAA,CACA,yBAAA,CACA,cAAA,CACA,aAAA,CACA,oBAAA,CAEA,wBAAA,0BAAA,CAGJ,oBACI,iBAAA,CACA,uBAAA,CACA,OAAA,CACA,eAAA,CACA,gBAAA,CACA,eAAA,CACA,4BAAA,CACA,sCAAA,CACA,iBAAA,CACA,sCAAA,CACA,WAAA,CACA,aAAA,CAGJ,iBACI,YAAA,CACA,kBAAA,CACA,UAAA,CACA,gBAAA,CACA,eAAA,CACA,WAAA,CACA,0BAAA,CACA,eAAA,CACA,eAAA,CACA,cAAA,CACA,mCAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CAEA,gDAEI,4CAAA,CACA,uBAAA,CAIR,kBACI,gBAAA,CACA,gBAAA,CACA,yBAAA,CAGJ,QACI,eAAA,CACA,iBAAA,CACA,gBAAA,CACA,eAAA,CACA,sCAAA,CACA,iCAAA,CACA,yBAAA,CACA,cAAA,CACA,kBAAA,CACA,mBAAA,CAEA,cACI,4BAAA,CACA,8BAAA,CACA,UAAA,CAKR,kBACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,gBAAA,CACA,iBAAA,CACA,sCAAA,CACA,iCAAA,CACA,yBAAA,CACA,gBAAA,CACA,WAAA,CACA,YAAA,CACA,4CAAA,CACA,wBAAA,CACA,gBAAA,CAEA,kDAEI,8BAAA,CACA,4CAAA,CACA,0BAAA,CAGJ,yBACI,UAAA,CACA,cAAA,CAIR,mBACI,gBAAA,CACA,aAAA,CAGJ,mBACI,iBAAA,CAGJ,qBACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,uBAAA,CACA,eAAA,CAGJ,qBACI,uCAAA,CAGJ,oBACI,QAAA,SAAA,CACA,IAAA,SAAA,CAAA","sourcesContent":[":host {\r\n    display: flex;\r\n    flex-direction: column;\r\n    height: 100%;\r\n    overflow: hidden;\r\n    background: var(--bs-body-bg);\r\n}\r\n\r\n// ── Layout ────────────────────────────────────────────────────────────────────\r\n.me-layout {\r\n    display: flex;\r\n    flex-direction: column;\r\n    height: 100%;\r\n    overflow: hidden;\r\n    position: relative;\r\n}\r\n\r\n// ── Drag over layout ──────────────────────────────────────────────────────────\r\n.me-layout--drag-over {\r\n    outline: 2px dashed var(--bs-primary);\r\n    outline-offset: -3px;\r\n}\r\n\r\n// ── Drag overlay ──────────────────────────────────────────────────────────────\r\n.me-drag-overlay {\r\n    position: absolute;\r\n    inset: 0;\r\n    z-index: 100;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    background: rgba(var(--bs-primary-rgb), 0.15);\r\n    border: 2px dashed var(--bs-primary);\r\n    font-size: 1.1rem;\r\n    font-weight: 600;\r\n    color: var(--bs-primary);\r\n    pointer-events: none;\r\n}\r\n\r\n// ── Drop hint (empty state) ────────────────────────────────────────────────────\r\n.me-drop-hint {\r\n    flex: 1;\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    justify-content: center;\r\n    color: var(--bs-secondary);\r\n    font-size: 0.85rem;\r\n    gap: 4px;\r\n    border: 2px dashed rgba(255,255,255,0.12);\r\n    margin: 12px;\r\n    border-radius: 8px;\r\n}\r\n\r\n// ── Loading ───────────────────────────────────────────────────────────────────\r\n.me-loading {\r\n    flex: 1;\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    justify-content: center;\r\n    color: var(--bs-secondary);\r\n}\r\n\r\n// ── Panes Grid ────────────────────────────────────────────────────────────────\r\n.me-panes {\r\n    flex: 1;\r\n    display: grid;\r\n    gap: 3px;\r\n    overflow: hidden;\r\n    background: #000;\r\n    min-height: 0;\r\n    align-items: stretch;\r\n    align-content: stretch;\r\n}\r\n\r\n.me-pane {\r\n    display: flex;\r\n    flex-direction: column;\r\n    overflow: hidden;\r\n    min-height: 0;\r\n    border-top: 3px solid rgba(255,255,255,0.1);\r\n    transition: border-top-color 0.15s;\r\n\r\n    &--active {\r\n        border-top-color: var(--bs-primary);\r\n    }\r\n\r\n    &--drag-over {\r\n        border-top-color: var(--bs-warning);\r\n        outline: 1px dashed var(--bs-warning);\r\n    }\r\n}\r\n\r\n.me-pane-header {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 5px;\r\n    padding: 2px 6px;\r\n    background: rgba(255,255,255,0.05);\r\n    font-size: 0.7rem;\r\n    color: var(--bs-secondary);\r\n    flex-shrink: 0;\r\n    cursor: grab;\r\n\r\n    &:active { cursor: grabbing; }\r\n\r\n    i { font-size: 0.65rem; }\r\n}\r\n\r\n.me-pane-title {\r\n    flex: 1;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    white-space: nowrap;\r\n}\r\n\r\n.me-pane-close {\r\n    background: none;\r\n    border: none;\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    padding: 0 2px;\r\n    font-size: 0.65rem;\r\n    line-height: 1;\r\n    opacity: 0.5;\r\n\r\n    &:hover { opacity: 1; color: var(--bs-danger); }\r\n}\r\n\r\n// .me-pane-body là ViewContainerRef anchor — rỗng, không cần chiếm space\r\n.me-pane-body {\r\n    display: none;\r\n}\r\n\r\n// ssh-tab / telnet-tab / serial-tab... là sibling sau header trong .me-pane,\r\n// cần lấy flex: 1 để chiếm toàn bộ phần còn lại\r\n.me-pane ::ng-deep ssh-tab,\r\n.me-pane ::ng-deep telnet-tab,\r\n.me-pane ::ng-deep serial-tab,\r\n.me-pane ::ng-deep base-terminal-tab,\r\n.me-pane ::ng-deep [class*=\"-tab\"] {\r\n    flex: 1;\r\n    min-height: 0;\r\n    overflow: hidden;\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n\r\n// Bên trong tab: .content chiếm flex: 1, toolbar không lấn vào xterm\r\n.me-pane ::ng-deep .content {\r\n    flex: 1;\r\n    min-height: 0;\r\n    overflow: hidden;\r\n}\r\n\r\n.me-pane ::ng-deep terminal-toolbar {\r\n    flex-shrink: 0;\r\n}\r\n\r\n.me-pane ::ng-deep .terminal-toolbar-spacer {\r\n    display: none;\r\n}\r\n\r\n// ── Command Bar ───────────────────────────────────────────────────────────────\r\n.me-cmdbar {\r\n    flex-shrink: 0;\r\n    border-top: 1px solid rgba(255,255,255,0.1);\r\n    background: var(--bs-body-bg);\r\n    padding: 8px 12px;\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 7px;\r\n}\r\n\r\n.me-cmdbar-top {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 8px;\r\n    flex-wrap: wrap;\r\n}\r\n\r\n.me-cmdbar-label {\r\n    font-size: 0.75rem;\r\n    font-weight: 700;\r\n    color: var(--bs-secondary);\r\n    text-transform: uppercase;\r\n    letter-spacing: 0.04em;\r\n    white-space: nowrap;\r\n    flex-shrink: 0;\r\n}\r\n\r\n.me-chips {\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    gap: 4px;\r\n    flex: 1;\r\n}\r\n\r\n.me-chip-wrap {\r\n    display: inline-flex;\r\n    align-items: center;\r\n\r\n    &:hover .me-chip-remove {\r\n        opacity: 1;\r\n        width: 18px;\r\n        margin-left: 1px;\r\n    }\r\n}\r\n\r\n.me-chip-remove {\r\n    background: none;\r\n    border: none;\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    padding: 0;\r\n    font-size: 0.55rem;\r\n    line-height: 1;\r\n    opacity: 0;\r\n    width: 0;\r\n    overflow: hidden;\r\n    transition: opacity 0.15s, width 0.15s;\r\n\r\n    &:hover { color: var(--bs-danger); }\r\n}\r\n\r\n.me-chip {\r\n    display: inline-flex;\r\n    align-items: center;\r\n    gap: 4px;\r\n    padding: 3px 9px;\r\n    border-radius: 100px;\r\n    font-size: 0.75rem;\r\n    font-weight: 600;\r\n    border: 1px solid rgba(255,255,255,0.15);\r\n    background: var(--bs-secondary-bg);\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    transition: all 0.15s;\r\n    -webkit-user-select: none;\r\n    user-select: none;\r\n\r\n    i { font-size: 0.6rem; }\r\n\r\n    &--on {\r\n        border-color: var(--bs-primary);\r\n        background: rgba(var(--bs-primary-rgb), 0.18);\r\n        color: var(--bs-body-color);\r\n    }\r\n\r\n    &:hover:not(.me-chip--on) {\r\n        border-color: rgba(255,255,255,0.35);\r\n        color: var(--bs-body-color);\r\n    }\r\n}\r\n\r\n// ── Add host search ───────────────────────────────────────────────────────────\r\n.me-addhost-wrap {\r\n    position: relative;\r\n    flex-shrink: 0;\r\n}\r\n\r\n.me-addhost-input-wrap {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 5px;\r\n    background: var(--bs-secondary-bg);\r\n    border: 1px solid rgba(255,255,255,0.15);\r\n    border-radius: 4px;\r\n    padding: 2px 7px;\r\n    transition: border-color 0.15s;\r\n\r\n    &:focus-within {\r\n        border-color: var(--bs-primary);\r\n    }\r\n}\r\n\r\n.me-addhost-icon {\r\n    font-size: 0.65rem;\r\n    color: var(--bs-secondary);\r\n    flex-shrink: 0;\r\n}\r\n\r\n.me-addhost-input {\r\n    background: none;\r\n    border: none;\r\n    outline: none;\r\n    color: var(--bs-body-color);\r\n    font-size: 0.72rem;\r\n    font-weight: 600;\r\n    width: 90px;\r\n    min-width: 0;\r\n\r\n    &::placeholder { color: var(--bs-secondary); }\r\n}\r\n\r\n.me-addhost-clear {\r\n    font-size: 0.6rem;\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    flex-shrink: 0;\r\n    transition: color 0.1s;\r\n\r\n    &:hover { color: var(--bs-body-color); }\r\n}\r\n\r\n.me-addhost-results {\r\n    position: absolute;\r\n    bottom: calc(100% + 6px);\r\n    right: 0;\r\n    min-width: 210px;\r\n    max-height: 240px;\r\n    overflow-y: auto;\r\n    background: var(--bs-body-bg);\r\n    border: 1px solid rgba(255,255,255,0.15);\r\n    border-radius: 6px;\r\n    box-shadow: 0 -6px 20px rgba(0,0,0,0.45);\r\n    z-index: 200;\r\n    padding: 4px 0;\r\n}\r\n\r\n.me-addhost-item {\r\n    display: flex;\r\n    align-items: center;\r\n    width: 100%;\r\n    padding: 5px 12px;\r\n    background: none;\r\n    border: none;\r\n    color: var(--bs-body-color);\r\n    font-size: 0.8rem;\r\n    text-align: left;\r\n    cursor: pointer;\r\n    transition: background 0.1s, color 0.1s;\r\n    white-space: nowrap;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n\r\n    &:hover,\r\n    &--active {\r\n        background: rgba(var(--bs-primary-rgb), 0.15);\r\n        color: var(--bs-primary);\r\n    }\r\n}\r\n\r\n.me-addhost-empty {\r\n    padding: 6px 12px;\r\n    font-size: 0.75rem;\r\n    color: var(--bs-secondary);\r\n}\r\n\r\n.me-btn {\r\n    padding: 2px 9px;\r\n    border-radius: 4px;\r\n    font-size: 0.72rem;\r\n    font-weight: 600;\r\n    border: 1px solid rgba(255,255,255,0.15);\r\n    background: var(--bs-secondary-bg);\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    white-space: nowrap;\r\n    transition: all 0.15s;\r\n\r\n    &:hover {\r\n        background: var(--bs-primary);\r\n        border-color: var(--bs-primary);\r\n        color: #fff;\r\n    }\r\n}\r\n\r\n// ── Broadcast row ─────────────────────────────────────────────────────────────\r\n.me-broadcast-row {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 7px;\r\n    padding: 5px 10px;\r\n    border-radius: 5px;\r\n    border: 1px solid rgba(255,255,255,0.12);\r\n    background: var(--bs-secondary-bg);\r\n    color: var(--bs-secondary);\r\n    font-size: 0.78rem;\r\n    cursor: text;\r\n    outline: none;\r\n    transition: border-color 0.15s, background 0.15s;\r\n    -webkit-user-select: none;\r\n    user-select: none;\r\n\r\n    &:focus,\r\n    &--active {\r\n        border-color: var(--bs-primary);\r\n        background: rgba(var(--bs-primary-rgb), 0.08);\r\n        color: var(--bs-body-color);\r\n    }\r\n\r\n    &--empty {\r\n        opacity: 0.5;\r\n        cursor: default;\r\n    }\r\n}\r\n\r\n.me-broadcast-icon {\r\n    font-size: 0.72rem;\r\n    flex-shrink: 0;\r\n}\r\n\r\n.me-broadcast-hint {\r\n    font-style: italic;\r\n}\r\n\r\n.me-broadcast-typing {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 4px;\r\n    color: var(--bs-primary);\r\n    font-weight: 600;\r\n}\r\n\r\n.me-broadcast-cursor {\r\n    animation: me-blink 1s step-end infinite;\r\n}\r\n\r\n@keyframes me-blink {\r\n    0%, 100% { opacity: 1; }\r\n    50%       { opacity: 0; }\r\n}\r\n\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":host{display:flex;flex-direction:column;height:100%;overflow:hidden}.content{display:flex;flex-direction:column;height:100%;padding:1.5rem 2rem;overflow:hidden;width:100%;box-sizing:border-box}.header-section{flex-shrink:0;width:100%;margin-bottom:.5rem}.header-section .header-top{display:flex;align-items:center;justify-content:space-between;margin-bottom:.75rem}.header-section .header-left{display:flex;align-items:center;gap:.5rem}.header-section .header-right{display:flex;align-items:center;gap:4px}.header-section h3{font-size:1.8rem;font-weight:800;color:var(--bs-body-color);margin:0}.header-section .search-wrap{position:relative;display:flex;align-items:center}.header-section .search-clear{position:absolute;right:12px;background:none;border:none;color:var(--bs-secondary);cursor:pointer;font-size:12px;padding:4px}.header-section .search-clear:hover{color:var(--bs-body-color)}.header-section .form-control{border-radius:8px;padding:.75rem 1.25rem;transition:all .3s;background:var(--bs-secondary-bg);border-color:rgba(255,255,255,.35);color:var(--bs-body-color)}.header-section .form-control:focus{border-color:var(--bs-primary);box-shadow:0 0 0 .2rem rgba(var(--bs-primary-rgb), 0.15)}.header-section .form-control::placeholder{color:var(--bs-secondary)}.back-btn{width:32px;height:32px;border:none;background:var(--bs-secondary-bg);border-radius:6px;color:var(--bs-body-color);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:14px}.back-btn:hover{background:var(--bs-tertiary-bg)}.view-btn{width:32px;height:32px;border:none;background:rgba(0,0,0,0);border-radius:6px;color:var(--bs-secondary);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:13px;transition:all .15s}.view-btn.active{background:var(--bs-primary);color:#fff}.view-btn:not(.active):hover{background:var(--bs-secondary-bg)}.scroll-container{flex-grow:1;flex-shrink:1;overflow-y:auto;overflow-x:hidden;margin-top:1rem;padding-right:8px}.scroll-container::-webkit-scrollbar{width:6px}.scroll-container::-webkit-scrollbar-thumb{background:#ced4da;border-radius:10px}.group-title{position:sticky;top:0;z-index:5;display:flex;align-items:center;justify-content:space-between;font-size:1.5rem;font-weight:700;color:var(--bs-body-color);background:var(--bs-body-bg);padding-bottom:.5rem;border-bottom:2px solid rgba(255,255,255,.35);margin-bottom:1rem}.btn-new{display:flex;align-items:center;gap:6px;padding:5px 12px;background:var(--bs-secondary-bg);border:1px solid rgba(255,255,255,.35);border-radius:6px;font-size:.8rem;font-weight:600;color:var(--bs-body-color);cursor:pointer;transition:all .15s;white-space:nowrap}.btn-new i{font-size:.7rem}.btn-new:hover{background:var(--bs-primary);border-color:var(--bs-primary);color:#fff}.connection-group{display:grid;gap:12px;margin-bottom:2.5rem;grid-template-columns:repeat(auto-fill, minmax(160px, 280px))}@media(max-width: 400px){.connection-group{grid-template-columns:1fr}}.connection-group--recent{max-height:90px;overflow:hidden}.card{position:relative;overflow:visible;z-index:1;height:90px;box-sizing:border-box;width:100%;border:1px solid rgba(255,255,255,.35);border-radius:8px;background:var(--bs-body-bg);cursor:pointer;transition:background .15s}.card:hover,.card.show{background-color:var(--bs-secondary-bg)}.card:hover .btn-dots,.card.show .btn-dots{opacity:1}.card:has(.show){z-index:100}.card .card-body{padding:1rem .75rem;height:100%;display:flex;flex-direction:column;justify-content:space-between}.card .card-top{display:flex;align-items:center;gap:8px;min-width:0}.card .icon{width:1.25rem;height:1.25rem;display:inline-flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0;color:var(--bs-secondary)}.card h6{font-size:1.1rem;font-weight:600;margin:0;padding-right:24px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--bs-body-color)}.card .info-text p{font-size:.85rem;margin:0;color:var(--bs-body-color);opacity:.5;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.card .card-options{position:absolute;top:.4rem;right:.4rem;z-index:5}.list-group{display:flex;flex-direction:column;gap:2px;margin-bottom:2.5rem;border-radius:0;border:none}.list-item{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:8px;cursor:pointer;position:relative;transition:background .1s}.list-item:hover{background:var(--bs-secondary-bg)}.list-item:hover .btn-dots{opacity:1}.list-item .icon{width:1.25rem;height:1.25rem;display:inline-flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0;color:var(--bs-secondary)}.list-item .list-body{flex:1;min-width:0;display:flex;flex-direction:column;gap:2px}.list-item .list-title{font-size:1rem;font-weight:600;color:var(--bs-body-color);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.list-item .list-sub{font-size:.8rem;color:var(--bs-body-color);opacity:.5;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.list-item .card-options{position:relative;flex-shrink:0}.list-group-tag{display:inline-flex;align-items:center;margin-top:3px;font-size:.75rem;color:var(--bs-primary);opacity:.8;cursor:pointer}.list-group-tag:hover{opacity:1;text-decoration:underline}.btn-dots{width:24px;height:24px;border:none;background:rgba(0,0,0,0);border-radius:4px;color:var(--bs-secondary);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:12px;opacity:0;transition:opacity .15s,background .15s}.btn-dots:hover,.btn-dots[aria-expanded=true]{background:var(--bs-secondary-bg);color:var(--bs-body-color);opacity:1 !important}::ng-deep .dropdown-menu{z-index:1050;box-shadow:0 5px 15px rgba(0,0,0,.2);border:none;min-width:120px}.empty-state{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:3rem 1rem;color:var(--bs-secondary);text-align:center}.header-divider{width:1px;height:20px;background:rgba(255,255,255,.2);margin:0 2px}.status-dot{width:8px;height:8px;border-radius:50%;flex-shrink:0;background:rgba(0,0,0,0)}.status-dot.status-online{background:#a3be8c}.status-dot.status-offline{background:#bf616a}.status-dot.status-checking{background:#ebcb8b;animation:status-pulse 1s ease-in-out infinite}.card-status-dot{position:absolute;bottom:7px;left:9px}@keyframes status-pulse{0%,100%{opacity:1}50%{opacity:.3}}[draggable=true]{cursor:grab}[draggable=true]:active{cursor:grabbing}.card.drag-over,.list-item.drag-over{border-color:var(--bs-primary) !important;background:rgba(var(--bs-primary-rgb), 0.12) !important}.list-item.keyboard-selected{background:var(--bs-secondary-bg);outline:1px solid var(--bs-primary);outline-offset:-1px}.connection-group--recent-list{max-height:90px;overflow:hidden;margin-bottom:1.5rem}.card--selectable{cursor:pointer !important;-webkit-user-select:none;user-select:none}.card--selected{border-color:var(--bs-primary) !important;background:rgba(var(--bs-primary-rgb), 0.15) !important}.list-item--selected{background:rgba(var(--bs-primary-rgb), 0.15) !important;outline:1px solid var(--bs-primary);outline-offset:-1px}.card--active{box-shadow:inset 3px 0 0 var(--bs-primary),0 0 0 1px rgba(var(--bs-primary-rgb), 0.25)}.list-item--active{box-shadow:inset 3px 0 0 var(--bs-primary)}.card--selected:hover,.list-item--selected:hover{background:rgba(var(--bs-primary-rgb), 0.22) !important}.host-context-menu{position:fixed;display:block;z-index:2000;min-width:190px;padding:6px 0;background:var(--bs-body-bg);color:var(--bs-body-color);border:1px solid rgba(255,255,255,.16);border-radius:8px;box-shadow:0 10px 30px rgba(0,0,0,.35);user-select:none}.host-context-menu .dropdown-item{display:flex;align-items:center;width:100%;gap:2px;padding:7px 12px;border:0;background:transparent;color:inherit;text-align:left;font-size:.86rem}.host-context-menu .dropdown-item:hover{background:var(--bs-secondary-bg)}.host-context-menu .dropdown-divider{height:1px;margin:5px 0;background:rgba(255,255,255,.12)}.host-checkbox{position:absolute;top:6px;left:8px;z-index:10;cursor:pointer;margin:0}.host-checkbox input[type=checkbox]{width:16px;height:16px;cursor:pointer;accent-color:var(--bs-primary)}.list-checkbox{width:16px;height:16px;flex-shrink:0;cursor:pointer;accent-color:var(--bs-primary)}.selection-count{font-size:.85rem;color:var(--bs-secondary);align-self:center;white-space:nowrap}.multiexec-bar{flex-shrink:0;border-top:1px solid rgba(255,255,255,.12);padding:10px 0 0 0;margin-top:4px}.multiexec-bar .multiexec-header{display:flex;align-items:center;font-size:.8rem;font-weight:700;color:var(--bs-secondary);text-transform:uppercase;letter-spacing:.04em;margin-bottom:8px}.multiexec-bar .multiexec-target-count{font-weight:400;text-transform:none;letter-spacing:0}.multiexec-bar .multiexec-targets{display:flex;flex-wrap:wrap;gap:5px;margin-bottom:8px}.multiexec-bar .multiexec-chip{display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:100px;font-size:.78rem;font-weight:600;border:1px solid rgba(255,255,255,.15);background:var(--bs-secondary-bg);color:var(--bs-secondary);cursor:pointer;transition:all .15s;-webkit-user-select:none;user-select:none}.multiexec-bar .multiexec-chip i{font-size:.65rem}.multiexec-bar .multiexec-chip.active{border-color:var(--bs-primary);background:rgba(var(--bs-primary-rgb), 0.18);color:var(--bs-body-color)}.multiexec-bar .multiexec-chip:hover:not(.active){border-color:rgba(255,255,255,.3);color:var(--bs-body-color)}.multiexec-bar .multiexec-empty{font-size:.8rem;color:var(--bs-secondary);font-style:italic;padding:4px 0 8px}.multiexec-bar .multiexec-input-row{display:flex;gap:8px}.multiexec-bar .multiexec-input-row .form-control{font-size:.85rem;padding:6px 12px;background:var(--bs-secondary-bg);border-color:rgba(255,255,255,.2);color:var(--bs-body-color);border-radius:6px}.multiexec-bar .multiexec-input-row .form-control:focus{border-color:var(--bs-primary);box-shadow:0 0 0 .15rem rgba(var(--bs-primary-rgb), 0.2)}.multiexec-bar .multiexec-input-row .form-control::placeholder{color:var(--bs-secondary)}.multiexec-bar .btn-send{flex-shrink:0;padding:6px 14px;background:var(--bs-primary);border:none;border-radius:6px;color:#fff;font-size:.82rem;font-weight:600;cursor:pointer;display:flex;align-items:center;gap:5px;white-space:nowrap;transition:opacity .15s}.multiexec-bar .btn-send:hover:not(:disabled){opacity:.85}.multiexec-bar .btn-send:disabled{opacity:.4;cursor:default}.btn-new--primary{background:var(--bs-primary) !important;border-color:var(--bs-primary) !important;color:#fff !important}.btn-new--primary:hover{opacity:.85}.search-suggestions{position:absolute;top:calc(100% + 6px);left:0;right:0;z-index:1000;background:var(--bs-body-bg);border:1px solid rgba(255,255,255,.13);border-radius:10px;box-shadow:0 8px 32px rgba(0,0,0,.35),0 2px 8px rgba(0,0,0,.2);overflow:hidden;will-change:opacity,transform;animation:suggestions-in .12s ease-out}.search-suggestions .suggestions-header{display:flex;align-items:center;gap:7px;padding:8px 12px 6px;font-size:.72rem;color:var(--bs-secondary);border-bottom:1px solid rgba(255,255,255,.07)}.search-suggestions .suggestions-header .suggestions-trigger{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;background:var(--bs-primary);color:#fff;border-radius:3px;font-size:.7rem;font-weight:700;flex-shrink:0;line-height:1}.search-suggestions .suggestions-section-label{padding:6px 12px 2px;font-size:.63rem;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:var(--bs-secondary);opacity:.55}.search-suggestions .suggestion-item{display:flex;align-items:center;gap:10px;padding:7px 12px;cursor:pointer;border-left:2px solid rgba(0,0,0,0);transition:background .1s,border-color .1s}.search-suggestions .suggestion-item:hover{background:var(--bs-secondary-bg)}.search-suggestions .suggestion-item.active{background:rgba(var(--bs-primary-rgb), 0.1);border-left-color:var(--bs-primary)}.search-suggestions .suggestion-item.active .suggestion-label{color:var(--bs-primary)}.search-suggestions .suggestion-item .suggestion-icon{width:18px;text-align:center;flex-shrink:0;font-size:.78rem;color:var(--bs-secondary);opacity:.7}.search-suggestions .suggestion-item .suggestion-body{flex:1;min-width:0;display:flex;align-items:baseline;gap:10px}.search-suggestions .suggestion-item .suggestion-label{font-family:\"Cascadia Code\",\"Fira Code\",\"Consolas\",monospace;font-size:.82rem;font-weight:600;color:var(--bs-body-color);white-space:nowrap;transition:color .1s}.search-suggestions .suggestion-item .suggestion-hint{font-size:.74rem;color:var(--bs-secondary);opacity:.65;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.search-suggestions .suggestions-footer{display:flex;align-items:center;gap:5px;padding:5px 12px 6px;border-top:1px solid rgba(255,255,255,.07);font-size:.67rem;color:var(--bs-secondary);opacity:.6}.search-suggestions .suggestions-footer kbd{display:inline-flex;align-items:center;justify-content:center;min-width:20px;height:16px;padding:0 4px;background:var(--bs-secondary-bg);border:1px solid rgba(255,255,255,.15);border-radius:3px;font-size:.64rem;font-family:inherit;color:var(--bs-body-color);line-height:1}.search-suggestions .suggestions-footer span{margin-right:6px}@keyframes suggestions-in{from{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}", "",{"version":3,"sources":["webpack://./src/components/connectionPanel.component.scss"],"names":[],"mappings":"AAAA,MACI,YAAA,CACA,qBAAA,CACA,WAAA,CACA,eAAA,CAGJ,SACI,YAAA,CACA,qBAAA,CACA,WAAA,CACA,mBAAA,CACA,eAAA,CACA,UAAA,CACA,qBAAA,CAIJ,gBACI,aAAA,CACA,UAAA,CACA,mBAAA,CAEA,4BACI,YAAA,CACA,kBAAA,CACA,6BAAA,CACA,oBAAA,CAGJ,6BACI,YAAA,CACA,kBAAA,CACA,SAAA,CAGJ,8BACI,YAAA,CACA,kBAAA,CACA,OAAA,CAGJ,mBACI,gBAAA,CACA,eAAA,CACA,0BAAA,CACA,QAAA,CAGJ,6BACI,iBAAA,CACA,YAAA,CACA,kBAAA,CAGJ,8BACI,iBAAA,CACA,UAAA,CACA,eAAA,CACA,WAAA,CACA,yBAAA,CACA,cAAA,CACA,cAAA,CACA,WAAA,CACA,oCAAA,0BAAA,CAGJ,8BACI,iBAAA,CACA,sBAAA,CACA,kBAAA,CACA,iCAAA,CACA,kCAAA,CACA,0BAAA,CAEA,oCACI,8BAAA,CACA,wDAAA,CAGJ,2CAAA,yBAAA,CAIR,UACI,UAAA,CACA,WAAA,CACA,WAAA,CACA,iCAAA,CACA,iBAAA,CACA,0BAAA,CACA,cAAA,CACA,YAAA,CACA,kBAAA,CACA,sBAAA,CACA,cAAA,CACA,gBAAA,gCAAA,CAGJ,UACI,UAAA,CACA,WAAA,CACA,WAAA,CACA,wBAAA,CACA,iBAAA,CACA,yBAAA,CACA,cAAA,CACA,YAAA,CACA,kBAAA,CACA,sBAAA,CACA,cAAA,CACA,mBAAA,CAEA,iBACI,4BAAA,CACA,UAAA,CAEJ,6BAAA,iCAAA,CAIJ,kBACI,WAAA,CACA,aAAA,CACA,eAAA,CACA,iBAAA,CACA,eAAA,CACA,iBAAA,CAEA,qCAAA,SAAA,CACA,2CACI,kBAAA,CACA,kBAAA,CAKR,aACI,eAAA,CACA,KAAA,CACA,SAAA,CACA,YAAA,CACA,kBAAA,CACA,6BAAA,CACA,gBAAA,CACA,eAAA,CACA,0BAAA,CACA,4BAAA,CACA,oBAAA,CACA,6CAAA,CACA,kBAAA,CAGJ,SACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,gBAAA,CACA,iCAAA,CACA,sCAAA,CACA,iBAAA,CACA,eAAA,CACA,eAAA,CACA,0BAAA,CACA,cAAA,CACA,mBAAA,CACA,kBAAA,CAEA,WAAA,eAAA,CACA,eACI,4BAAA,CACA,8BAAA,CACA,UAAA,CAKR,kBACI,YAAA,CACA,QAAA,CACA,oBAAA,CACA,6DAAA,CAEA,yBANJ,kBAOQ,yBAAA,CAAA,CAKR,0BACI,eAAA,CACA,eAAA,CAIJ,MACI,iBAAA,CACA,gBAAA,CACA,SAAA,CACA,WAAA,CACA,qBAAA,CACA,UAAA,CACA,sCAAA,CACA,iBAAA,CACA,4BAAA,CACA,cAAA,CACA,0BAAA,CAEA,uBACI,uCAAA,CACA,2CAAA,SAAA,CAGJ,iBACI,WAAA,CAGJ,iBACI,mBAAA,CACA,WAAA,CACA,YAAA,CACA,qBAAA,CACA,6BAAA,CAGJ,gBACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,WAAA,CAGJ,YACI,aAAA,CACA,cAAA,CACA,mBAAA,CACA,kBAAA,CACA,sBAAA,CACA,gBAAA,CACA,aAAA,CACA,yBAAA,CAGJ,SACI,gBAAA,CACA,eAAA,CACA,QAAA,CACA,kBAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CACA,0BAAA,CAGJ,mBACI,gBAAA,CACA,QAAA,CACA,0BAAA,CACA,UAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CAGJ,oBACI,iBAAA,CACA,SAAA,CACA,WAAA,CACA,SAAA,CAKR,YACI,YAAA,CACA,qBAAA,CACA,OAAA,CACA,oBAAA,CACA,eAAA,CACA,WAAA,CAGJ,WACI,YAAA,CACA,kBAAA,CACA,QAAA,CACA,iBAAA,CACA,iBAAA,CACA,cAAA,CACA,iBAAA,CACA,yBAAA,CAEA,iBACI,iCAAA,CACA,2BAAA,SAAA,CAGJ,iBACI,aAAA,CACA,cAAA,CACA,mBAAA,CACA,kBAAA,CACA,sBAAA,CACA,gBAAA,CACA,aAAA,CACA,yBAAA,CAGJ,sBACI,MAAA,CACA,WAAA,CACA,YAAA,CACA,qBAAA,CACA,OAAA,CAGJ,uBACI,cAAA,CACA,eAAA,CACA,0BAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CAGJ,qBACI,eAAA,CACA,0BAAA,CACA,UAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CAGJ,yBACI,iBAAA,CACA,aAAA,CAIR,gBACI,mBAAA,CACA,kBAAA,CACA,cAAA,CACA,gBAAA,CACA,uBAAA,CACA,UAAA,CACA,cAAA,CAEA,sBACI,SAAA,CACA,yBAAA,CAKR,UACI,UAAA,CACA,WAAA,CACA,WAAA,CACA,wBAAA,CACA,iBAAA,CACA,yBAAA,CACA,cAAA,CACA,YAAA,CACA,kBAAA,CACA,sBAAA,CACA,cAAA,CACA,SAAA,CACA,uCAAA,CAEA,8CACI,iCAAA,CACA,0BAAA,CACA,oBAAA,CAKR,yBACI,YAAA,CACA,oCAAA,CACA,WAAA,CACA,eAAA,CAIJ,aACI,YAAA,CACA,qBAAA,CACA,kBAAA,CACA,sBAAA,CACA,iBAAA,CACA,yBAAA,CACA,iBAAA,CAIJ,gBACI,SAAA,CACA,WAAA,CACA,+BAAA,CACA,YAAA,CAIJ,YACI,SAAA,CACA,UAAA,CACA,iBAAA,CACA,aAAA,CACA,wBAAA,CAEA,0BAAA,kBAAA,CACA,2BAAA,kBAAA,CACA,4BACI,kBAAA,CACA,8CAAA,CAIR,iBACI,iBAAA,CACA,UAAA,CACA,QAAA,CAGJ,wBACI,QAAA,SAAA,CACA,IAAA,UAAA,CAAA,CAIJ,iBAAA,WAAA,CACA,wBAAA,eAAA,CAEA,qCAEI,yCAAA,CACA,uDAAA,CAIJ,6BACI,iCAAA,CACA,mCAAA,CACA,mBAAA,CAIJ,+BACI,eAAA,CACA,eAAA,CACA,oBAAA,CAIJ,kBACI,yBAAA,CACA,wBAAA,CACA,gBAAA,CAGJ,gBACI,yCAAA,CACA,uDAAA,CAGJ,qBACI,uDAAA,CACA,mCAAA,CACA,mBAAA,CAGJ,eACI,iBAAA,CACA,OAAA,CACA,QAAA,CACA,UAAA,CACA,cAAA,CACA,QAAA,CAEA,oCACI,UAAA,CACA,WAAA,CACA,cAAA,CACA,8BAAA,CAIR,eACI,UAAA,CACA,WAAA,CACA,aAAA,CACA,cAAA,CACA,8BAAA,CAGJ,iBACI,gBAAA,CACA,yBAAA,CACA,iBAAA,CACA,kBAAA,CAIJ,eACI,aAAA,CACA,0CAAA,CACA,kBAAA,CACA,cAAA,CAEA,iCACI,YAAA,CACA,kBAAA,CACA,eAAA,CACA,eAAA,CACA,yBAAA,CACA,wBAAA,CACA,oBAAA,CACA,iBAAA,CAGJ,uCACI,eAAA,CACA,mBAAA,CACA,gBAAA,CAGJ,kCACI,YAAA,CACA,cAAA,CACA,OAAA,CACA,iBAAA,CAGJ,+BACI,mBAAA,CACA,kBAAA,CACA,OAAA,CACA,gBAAA,CACA,mBAAA,CACA,gBAAA,CACA,eAAA,CACA,sCAAA,CACA,iCAAA,CACA,yBAAA,CACA,cAAA,CACA,mBAAA,CACA,wBAAA,CACA,gBAAA,CAEA,iCAAA,gBAAA,CAEA,sCACI,8BAAA,CACA,4CAAA,CACA,0BAAA,CAGJ,kDACI,iCAAA,CACA,0BAAA,CAIR,gCACI,eAAA,CACA,yBAAA,CACA,iBAAA,CACA,iBAAA,CAGJ,oCACI,YAAA,CACA,OAAA,CAEA,kDACI,gBAAA,CACA,gBAAA,CACA,iCAAA,CACA,iCAAA,CACA,0BAAA,CACA,iBAAA,CAEA,wDACI,8BAAA,CACA,wDAAA,CAGJ,+DAAA,yBAAA,CAIR,yBACI,aAAA,CACA,gBAAA,CACA,4BAAA,CACA,WAAA,CACA,iBAAA,CACA,UAAA,CACA,gBAAA,CACA,eAAA,CACA,cAAA,CACA,YAAA,CACA,kBAAA,CACA,OAAA,CACA,kBAAA,CACA,uBAAA,CAEA,8CAAA,WAAA,CACA,kCAAA,UAAA,CAAA,cAAA,CAIR,kBACI,uCAAA,CACA,yCAAA,CACA,qBAAA,CAEA,wBACI,WAAA,CAKR,oBACI,iBAAA,CACA,oBAAA,CACA,MAAA,CACA,OAAA,CACA,YAAA,CACA,4BAAA,CACA,sCAAA,CACA,kBAAA,CACA,8DAAA,CACA,eAAA,CACA,6BAAA,CACA,sCAAA,CAEA,wCACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,oBAAA,CACA,gBAAA,CACA,yBAAA,CACA,6CAAA,CAEA,6DACI,mBAAA,CACA,kBAAA,CACA,sBAAA,CACA,UAAA,CACA,WAAA,CACA,4BAAA,CACA,UAAA,CACA,iBAAA,CACA,eAAA,CACA,eAAA,CACA,aAAA,CACA,aAAA,CAIR,+CACI,oBAAA,CACA,gBAAA,CACA,eAAA,CACA,oBAAA,CACA,wBAAA,CACA,yBAAA,CACA,WAAA,CAGJ,qCACI,YAAA,CACA,kBAAA,CACA,QAAA,CACA,gBAAA,CACA,cAAA,CACA,mCAAA,CACA,0CAAA,CAEA,2CACI,iCAAA,CAGJ,4CACI,2CAAA,CACA,mCAAA,CAEA,8DAAA,uBAAA,CAGJ,sDACI,UAAA,CACA,iBAAA,CACA,aAAA,CACA,gBAAA,CACA,yBAAA,CACA,UAAA,CAGJ,sDACI,MAAA,CACA,WAAA,CACA,YAAA,CACA,oBAAA,CACA,QAAA,CAGJ,uDACI,4DAAA,CACA,gBAAA,CACA,eAAA,CACA,0BAAA,CACA,kBAAA,CACA,oBAAA,CAGJ,sDACI,gBAAA,CACA,yBAAA,CACA,WAAA,CACA,kBAAA,CACA,eAAA,CACA,sBAAA,CAIR,wCACI,YAAA,CACA,kBAAA,CACA,OAAA,CACA,oBAAA,CACA,0CAAA,CACA,gBAAA,CACA,yBAAA,CACA,UAAA,CAEA,4CACI,mBAAA,CACA,kBAAA,CACA,sBAAA,CACA,cAAA,CACA,WAAA,CACA,aAAA,CACA,iCAAA,CACA,sCAAA,CACA,iBAAA,CACA,gBAAA,CACA,mBAAA,CACA,0BAAA,CACA,aAAA,CAGJ,6CACI,gBAAA,CAKZ,0BACI,KAAA,SAAA,CAAA,0BAAA,CACA,GAAA,SAAA,CAAA,uBAAA,CAAA","sourcesContent":[":host {\r\n    display: flex;\r\n    flex-direction: column;\r\n    height: 100%;\r\n    overflow: hidden;\r\n}\r\n\r\n.content {\r\n    display: flex;\r\n    flex-direction: column;\r\n    height: 100%;\r\n    padding: 1.5rem 2rem;\r\n    overflow: hidden;\r\n    width: 100%;\r\n    box-sizing: border-box;\r\n}\r\n\r\n// ── Header ────────────────────────────────────────────────────────────────────\r\n.header-section {\r\n    flex-shrink: 0;\r\n    width: 100%;\r\n    margin-bottom: 0.5rem;\r\n\r\n    .header-top {\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: space-between;\r\n        margin-bottom: 0.75rem;\r\n    }\r\n\r\n    .header-left {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 0.5rem;\r\n    }\r\n\r\n    .header-right {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 4px;\r\n    }\r\n\r\n    h3 {\r\n        font-size: 1.8rem;\r\n        font-weight: 800;\r\n        color: var(--bs-body-color);\r\n        margin: 0;\r\n    }\r\n\r\n    .search-wrap {\r\n        position: relative;\r\n        display: flex;\r\n        align-items: center;\r\n    }\r\n\r\n    .search-clear {\r\n        position: absolute;\r\n        right: 12px;\r\n        background: none;\r\n        border: none;\r\n        color: var(--bs-secondary);\r\n        cursor: pointer;\r\n        font-size: 12px;\r\n        padding: 4px;\r\n        &:hover { color: var(--bs-body-color); }\r\n    }\r\n\r\n    .form-control {\r\n        border-radius: 8px;\r\n        padding: 0.75rem 1.25rem;\r\n        transition: all 0.3s;\r\n        background: var(--bs-secondary-bg);\r\n        border-color: rgba(255,255,255,0.35);\r\n        color: var(--bs-body-color);\r\n\r\n        &:focus {\r\n            border-color: var(--bs-primary);\r\n            box-shadow: 0 0 0 0.2rem rgba(var(--bs-primary-rgb), 0.15);\r\n        }\r\n\r\n        &::placeholder { color: var(--bs-secondary); }\r\n    }\r\n}\r\n\r\n.back-btn {\r\n    width: 32px;\r\n    height: 32px;\r\n    border: none;\r\n    background: var(--bs-secondary-bg);\r\n    border-radius: 6px;\r\n    color: var(--bs-body-color);\r\n    cursor: pointer;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    font-size: 14px;\r\n    &:hover { background: var(--bs-tertiary-bg); }\r\n}\r\n\r\n.view-btn {\r\n    width: 32px;\r\n    height: 32px;\r\n    border: none;\r\n    background: transparent;\r\n    border-radius: 6px;\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    font-size: 13px;\r\n    transition: all 0.15s;\r\n\r\n    &.active {\r\n        background: var(--bs-primary);\r\n        color: #fff;\r\n    }\r\n    &:not(.active):hover { background: var(--bs-secondary-bg); }\r\n}\r\n\r\n// ── Scroll container ──────────────────────────────────────────────────────────\r\n.scroll-container {\r\n    flex-grow: 1;\r\n    flex-shrink: 1;\r\n    overflow-y: auto;\r\n    overflow-x: hidden;\r\n    margin-top: 1rem;\r\n    padding-right: 8px;\r\n\r\n    &::-webkit-scrollbar { width: 6px; }\r\n    &::-webkit-scrollbar-thumb {\r\n        background: #ced4da;\r\n        border-radius: 10px;\r\n    }\r\n}\r\n\r\n// ── Group title ───────────────────────────────────────────────────────────────\r\n.group-title {\r\n    position: sticky;\r\n    top: 0;\r\n    z-index: 5;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: space-between;\r\n    font-size: 1.5rem;\r\n    font-weight: 700;\r\n    color: var(--bs-body-color);\r\n    background: var(--bs-body-bg);\r\n    padding-bottom: 0.5rem;\r\n    border-bottom: 2px solid rgba(255,255,255,0.35);\r\n    margin-bottom: 1rem;\r\n}\r\n\r\n.btn-new {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 6px;\r\n    padding: 5px 12px;\r\n    background: var(--bs-secondary-bg);\r\n    border: 1px solid rgba(255,255,255,0.35);\r\n    border-radius: 6px;\r\n    font-size: 0.8rem;\r\n    font-weight: 600;\r\n    color: var(--bs-body-color);\r\n    cursor: pointer;\r\n    transition: all 0.15s;\r\n    white-space: nowrap;\r\n\r\n    i { font-size: 0.7rem; }\r\n    &:hover {\r\n        background: var(--bs-primary);\r\n        border-color: var(--bs-primary);\r\n        color: #fff;\r\n    }\r\n}\r\n\r\n// ── Grid ──────────────────────────────────────────────────────────────────────\r\n.connection-group {\r\n    display: grid;\r\n    gap: 12px;\r\n    margin-bottom: 2.5rem;\r\n    grid-template-columns: repeat(auto-fill, minmax(160px, 280px));\r\n\r\n    @media (max-width: 400px) {\r\n        grid-template-columns: 1fr;\r\n    }\r\n}\r\n\r\n// Recent: giới hạn đúng 1 hàng bất kể màn hình\r\n.connection-group--recent {\r\n    max-height: 90px;\r\n    overflow: hidden;\r\n}\r\n\r\n// ── Card ──────────────────────────────────────────────────────────────────────\r\n.card {\r\n    position: relative;\r\n    overflow: visible;\r\n    z-index: 1;\r\n    height: 90px;\r\n    box-sizing: border-box;\r\n    width: 100%;\r\n    border: 1px solid rgba(255,255,255,0.35);\r\n    border-radius: 8px;\r\n    background: var(--bs-body-bg);\r\n    cursor: pointer;\r\n    transition: background 0.15s;\r\n\r\n    &:hover, &.show {\r\n        background-color: var(--bs-secondary-bg);\r\n        .btn-dots { opacity: 1; }\r\n    }\r\n\r\n    &:has(.show) {\r\n        z-index: 100;\r\n    }\r\n\r\n    .card-body {\r\n        padding: 1rem 0.75rem;\r\n        height: 100%;\r\n        display: flex;\r\n        flex-direction: column;\r\n        justify-content: space-between;\r\n    }\r\n\r\n    .card-top {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 8px;\r\n        min-width: 0;\r\n    }\r\n\r\n    .icon {\r\n        width: 1.25rem;\r\n        height: 1.25rem;\r\n        display: inline-flex;\r\n        align-items: center;\r\n        justify-content: center;\r\n        font-size: 1.1rem;\r\n        flex-shrink: 0;\r\n        color: var(--bs-secondary);\r\n    }\r\n\r\n    h6 {\r\n        font-size: 1.1rem;\r\n        font-weight: 600;\r\n        margin: 0;\r\n        padding-right: 24px;\r\n        white-space: nowrap;\r\n        overflow: hidden;\r\n        text-overflow: ellipsis;\r\n        color: var(--bs-body-color);\r\n    }\r\n\r\n    .info-text p {\r\n        font-size: 0.85rem;\r\n        margin: 0;\r\n        color: var(--bs-body-color);\r\n        opacity: 0.5;\r\n        white-space: nowrap;\r\n        overflow: hidden;\r\n        text-overflow: ellipsis;\r\n    }\r\n\r\n    .card-options {\r\n        position: absolute;\r\n        top: 0.4rem;\r\n        right: 0.4rem;\r\n        z-index: 5;\r\n    }\r\n}\r\n\r\n// ── List ──────────────────────────────────────────────────────────────────────\r\n.list-group {\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 2px;\r\n    margin-bottom: 2.5rem;\r\n    border-radius: 0;\r\n    border: none;\r\n}\r\n\r\n.list-item {\r\n    display: flex;\r\n    align-items: center;\r\n    gap: 12px;\r\n    padding: 10px 12px;\r\n    border-radius: 8px;\r\n    cursor: pointer;\r\n    position: relative;\r\n    transition: background 0.1s;\r\n\r\n    &:hover {\r\n        background: var(--bs-secondary-bg);\r\n        .btn-dots { opacity: 1; }\r\n    }\r\n\r\n    .icon {\r\n        width: 1.25rem;\r\n        height: 1.25rem;\r\n        display: inline-flex;\r\n        align-items: center;\r\n        justify-content: center;\r\n        font-size: 1.1rem;\r\n        flex-shrink: 0;\r\n        color: var(--bs-secondary);\r\n    }\r\n\r\n    .list-body {\r\n        flex: 1;\r\n        min-width: 0;\r\n        display: flex;\r\n        flex-direction: column;\r\n        gap: 2px;\r\n    }\r\n\r\n    .list-title {\r\n        font-size: 1rem;\r\n        font-weight: 600;\r\n        color: var(--bs-body-color);\r\n        white-space: nowrap;\r\n        overflow: hidden;\r\n        text-overflow: ellipsis;\r\n    }\r\n\r\n    .list-sub {\r\n        font-size: 0.8rem;\r\n        color: var(--bs-body-color);\r\n        opacity: 0.5;\r\n        white-space: nowrap;\r\n        overflow: hidden;\r\n        text-overflow: ellipsis;\r\n    }\r\n\r\n    .card-options {\r\n        position: relative;\r\n        flex-shrink: 0;\r\n    }\r\n}\r\n\r\n.list-group-tag {\r\n    display: inline-flex;\r\n    align-items: center;\r\n    margin-top: 3px;\r\n    font-size: 0.75rem;\r\n    color: var(--bs-primary);\r\n    opacity: 0.8;\r\n    cursor: pointer;\r\n\r\n    &:hover {\r\n        opacity: 1;\r\n        text-decoration: underline;\r\n    }\r\n}\r\n\r\n// ── Menu button ───────────────────────────────────────────────────────────────\r\n.btn-dots {\r\n    width: 24px;\r\n    height: 24px;\r\n    border: none;\r\n    background: transparent;\r\n    border-radius: 4px;\r\n    color: var(--bs-secondary);\r\n    cursor: pointer;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    font-size: 12px;\r\n    opacity: 0;\r\n    transition: opacity 0.15s, background 0.15s;\r\n\r\n    &:hover, &[aria-expanded='true'] {\r\n        background: var(--bs-secondary-bg);\r\n        color: var(--bs-body-color);\r\n        opacity: 1 !important;\r\n    }\r\n}\r\n\r\n// ── Dropdown ──────────────────────────────────────────────────────────────────\r\n::ng-deep .dropdown-menu {\r\n    z-index: 1050;\r\n    box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2);\r\n    border: none;\r\n    min-width: 120px;\r\n}\r\n\r\n// ── Empty state ───────────────────────────────────────────────────────────────\r\n.empty-state {\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    justify-content: center;\r\n    padding: 3rem 1rem;\r\n    color: var(--bs-secondary);\r\n    text-align: center;\r\n}\r\n\r\n// ── Header divider ─────────────────────────────────────────────────────────────\r\n.header-divider {\r\n    width: 1px;\r\n    height: 20px;\r\n    background: rgba(255, 255, 255, 0.2);\r\n    margin: 0 2px;\r\n}\r\n\r\n// ── Status dots ────────────────────────────────────────────────────────────────\r\n.status-dot {\r\n    width: 8px;\r\n    height: 8px;\r\n    border-radius: 50%;\r\n    flex-shrink: 0;\r\n    background: transparent;\r\n\r\n    &.status-online  { background: #a3be8c; }\r\n    &.status-offline { background: #bf616a; }\r\n    &.status-checking {\r\n        background: #ebcb8b;\r\n        animation: status-pulse 1s ease-in-out infinite;\r\n    }\r\n}\r\n\r\n.card-status-dot {\r\n    position: absolute;\r\n    bottom: 7px;\r\n    left: 9px;\r\n}\r\n\r\n@keyframes status-pulse {\r\n    0%, 100% { opacity: 1; }\r\n    50%       { opacity: 0.3; }\r\n}\r\n\r\n// ── Drag & drop ────────────────────────────────────────────────────────────────\r\n[draggable='true'] { cursor: grab; }\r\n[draggable='true']:active { cursor: grabbing; }\r\n\r\n.card.drag-over,\r\n.list-item.drag-over {\r\n    border-color: var(--bs-primary) !important;\r\n    background: rgba(var(--bs-primary-rgb), 0.12) !important;\r\n}\r\n\r\n// ── Keyboard-selected search result ────────────────────────────────────────────\r\n.list-item.keyboard-selected {\r\n    background: var(--bs-secondary-bg);\r\n    outline: 1px solid var(--bs-primary);\r\n    outline-offset: -1px;\r\n}\r\n\r\n// ── Recent list mode (limit height) ───────────────────────────────────────────\r\n.connection-group--recent-list {\r\n    max-height: 90px;\r\n    overflow: hidden;\r\n    margin-bottom: 1.5rem;\r\n}\r\n\r\n// ── Selection mode ─────────────────────────────────────────────────────────────\r\n.card--selectable {\r\n    cursor: pointer !important;\r\n    -webkit-user-select: none;\r\n    user-select: none;\r\n}\r\n\r\n.card--selected {\r\n    border-color: var(--bs-primary) !important;\r\n    background: rgba(var(--bs-primary-rgb), 0.15) !important;\r\n}\r\n\r\n.list-item--selected {\r\n    background: rgba(var(--bs-primary-rgb), 0.15) !important;\r\n    outline: 1px solid var(--bs-primary);\r\n    outline-offset: -1px;\r\n}\r\n\r\n.host-checkbox {\r\n    position: absolute;\r\n    top: 6px;\r\n    left: 8px;\r\n    z-index: 10;\r\n    cursor: pointer;\r\n    margin: 0;\r\n\r\n    input[type='checkbox'] {\r\n        width: 16px;\r\n        height: 16px;\r\n        cursor: pointer;\r\n        accent-color: var(--bs-primary);\r\n    }\r\n}\r\n\r\n.list-checkbox {\r\n    width: 16px;\r\n    height: 16px;\r\n    flex-shrink: 0;\r\n    cursor: pointer;\r\n    accent-color: var(--bs-primary);\r\n}\r\n\r\n.selection-count {\r\n    font-size: 0.85rem;\r\n    color: var(--bs-secondary);\r\n    align-self: center;\r\n    white-space: nowrap;\r\n}\r\n\r\n// ── MultiExec Bar ──────────────────────────────────────────────────────────────\r\n.multiexec-bar {\r\n    flex-shrink: 0;\r\n    border-top: 1px solid rgba(255, 255, 255, 0.12);\r\n    padding: 10px 0 0 0;\r\n    margin-top: 4px;\r\n\r\n    .multiexec-header {\r\n        display: flex;\r\n        align-items: center;\r\n        font-size: 0.8rem;\r\n        font-weight: 700;\r\n        color: var(--bs-secondary);\r\n        text-transform: uppercase;\r\n        letter-spacing: 0.04em;\r\n        margin-bottom: 8px;\r\n    }\r\n\r\n    .multiexec-target-count {\r\n        font-weight: 400;\r\n        text-transform: none;\r\n        letter-spacing: 0;\r\n    }\r\n\r\n    .multiexec-targets {\r\n        display: flex;\r\n        flex-wrap: wrap;\r\n        gap: 5px;\r\n        margin-bottom: 8px;\r\n    }\r\n\r\n    .multiexec-chip {\r\n        display: inline-flex;\r\n        align-items: center;\r\n        gap: 4px;\r\n        padding: 4px 10px;\r\n        border-radius: 100px;\r\n        font-size: 0.78rem;\r\n        font-weight: 600;\r\n        border: 1px solid rgba(255, 255, 255, 0.15);\r\n        background: var(--bs-secondary-bg);\r\n        color: var(--bs-secondary);\r\n        cursor: pointer;\r\n        transition: all 0.15s;\r\n        -webkit-user-select: none;\r\n        user-select: none;\r\n\r\n        i { font-size: 0.65rem; }\r\n\r\n        &.active {\r\n            border-color: var(--bs-primary);\r\n            background: rgba(var(--bs-primary-rgb), 0.18);\r\n            color: var(--bs-body-color);\r\n        }\r\n\r\n        &:hover:not(.active) {\r\n            border-color: rgba(255, 255, 255, 0.3);\r\n            color: var(--bs-body-color);\r\n        }\r\n    }\r\n\r\n    .multiexec-empty {\r\n        font-size: 0.8rem;\r\n        color: var(--bs-secondary);\r\n        font-style: italic;\r\n        padding: 4px 0 8px;\r\n    }\r\n\r\n    .multiexec-input-row {\r\n        display: flex;\r\n        gap: 8px;\r\n\r\n        .form-control {\r\n            font-size: 0.85rem;\r\n            padding: 6px 12px;\r\n            background: var(--bs-secondary-bg);\r\n            border-color: rgba(255, 255, 255, 0.2);\r\n            color: var(--bs-body-color);\r\n            border-radius: 6px;\r\n\r\n            &:focus {\r\n                border-color: var(--bs-primary);\r\n                box-shadow: 0 0 0 0.15rem rgba(var(--bs-primary-rgb), 0.2);\r\n            }\r\n\r\n            &::placeholder { color: var(--bs-secondary); }\r\n        }\r\n    }\r\n\r\n    .btn-send {\r\n        flex-shrink: 0;\r\n        padding: 6px 14px;\r\n        background: var(--bs-primary);\r\n        border: none;\r\n        border-radius: 6px;\r\n        color: #fff;\r\n        font-size: 0.82rem;\r\n        font-weight: 600;\r\n        cursor: pointer;\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 5px;\r\n        white-space: nowrap;\r\n        transition: opacity 0.15s;\r\n\r\n        &:hover:not(:disabled) { opacity: 0.85; }\r\n        &:disabled { opacity: 0.4; cursor: default; }\r\n    }\r\n}\r\n\r\n.btn-new--primary {\r\n    background: var(--bs-primary) !important;\r\n    border-color: var(--bs-primary) !important;\r\n    color: #fff !important;\r\n\r\n    &:hover {\r\n        opacity: 0.85;\r\n    }\r\n}\r\n\r\n// ── Search suggestions (autocomplete) ──────────────────────────────────────────\r\n.search-suggestions {\r\n    position: absolute;\r\n    top: calc(100% + 6px);\r\n    left: 0;\r\n    right: 0;\r\n    z-index: 1000;\r\n    background: var(--bs-body-bg);\r\n    border: 1px solid rgba(255, 255, 255, 0.13);\r\n    border-radius: 10px;\r\n    box-shadow: 0 8px 32px rgba(0, 0, 0, 0.35), 0 2px 8px rgba(0, 0, 0, 0.2);\r\n    overflow: hidden;\r\n    will-change: opacity, transform;\r\n    animation: suggestions-in 0.12s ease-out;\r\n\r\n    .suggestions-header {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 7px;\r\n        padding: 8px 12px 6px;\r\n        font-size: 0.72rem;\r\n        color: var(--bs-secondary);\r\n        border-bottom: 1px solid rgba(255, 255, 255, 0.07);\r\n\r\n        .suggestions-trigger {\r\n            display: inline-flex;\r\n            align-items: center;\r\n            justify-content: center;\r\n            width: 16px;\r\n            height: 16px;\r\n            background: var(--bs-primary);\r\n            color: #fff;\r\n            border-radius: 3px;\r\n            font-size: 0.7rem;\r\n            font-weight: 700;\r\n            flex-shrink: 0;\r\n            line-height: 1;\r\n        }\r\n    }\r\n\r\n    .suggestions-section-label {\r\n        padding: 6px 12px 2px;\r\n        font-size: 0.63rem;\r\n        font-weight: 700;\r\n        letter-spacing: 0.07em;\r\n        text-transform: uppercase;\r\n        color: var(--bs-secondary);\r\n        opacity: 0.55;\r\n    }\r\n\r\n    .suggestion-item {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 10px;\r\n        padding: 7px 12px;\r\n        cursor: pointer;\r\n        border-left: 2px solid transparent;\r\n        transition: background 0.1s, border-color 0.1s;\r\n\r\n        &:hover {\r\n            background: var(--bs-secondary-bg);\r\n        }\r\n\r\n        &.active {\r\n            background: rgba(var(--bs-primary-rgb), 0.1);\r\n            border-left-color: var(--bs-primary);\r\n\r\n            .suggestion-label { color: var(--bs-primary); }\r\n        }\r\n\r\n        .suggestion-icon {\r\n            width: 18px;\r\n            text-align: center;\r\n            flex-shrink: 0;\r\n            font-size: 0.78rem;\r\n            color: var(--bs-secondary);\r\n            opacity: 0.7;\r\n        }\r\n\r\n        .suggestion-body {\r\n            flex: 1;\r\n            min-width: 0;\r\n            display: flex;\r\n            align-items: baseline;\r\n            gap: 10px;\r\n        }\r\n\r\n        .suggestion-label {\r\n            font-family: 'Cascadia Code', 'Fira Code', 'Consolas', monospace;\r\n            font-size: 0.82rem;\r\n            font-weight: 600;\r\n            color: var(--bs-body-color);\r\n            white-space: nowrap;\r\n            transition: color 0.1s;\r\n        }\r\n\r\n        .suggestion-hint {\r\n            font-size: 0.74rem;\r\n            color: var(--bs-secondary);\r\n            opacity: 0.65;\r\n            white-space: nowrap;\r\n            overflow: hidden;\r\n            text-overflow: ellipsis;\r\n        }\r\n    }\r\n\r\n    .suggestions-footer {\r\n        display: flex;\r\n        align-items: center;\r\n        gap: 5px;\r\n        padding: 5px 12px 6px;\r\n        border-top: 1px solid rgba(255, 255, 255, 0.07);\r\n        font-size: 0.67rem;\r\n        color: var(--bs-secondary);\r\n        opacity: 0.6;\r\n\r\n        kbd {\r\n            display: inline-flex;\r\n            align-items: center;\r\n            justify-content: center;\r\n            min-width: 20px;\r\n            height: 16px;\r\n            padding: 0 4px;\r\n            background: var(--bs-secondary-bg);\r\n            border: 1px solid rgba(255, 255, 255, 0.15);\r\n            border-radius: 3px;\r\n            font-size: 0.64rem;\r\n            font-family: inherit;\r\n            color: var(--bs-body-color);\r\n            line-height: 1;\r\n        }\r\n\r\n        span {\r\n            margin-right: 6px;\r\n        }\r\n    }\r\n}\r\n\r\n@keyframes suggestions-in {\r\n    from { opacity: 0; transform: translateY(-4px); }\r\n    to   { opacity: 1; transform: translateY(0); }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_indent = [];
pug_html = pug_html + "\n\u003Cdiv class=\"modal-header\"\u003E\n  \u003Ch5 class=\"modal-title\"\u003E\u003Ci class=\"fas fa-folder me-2\"\u003E\u003C\u002Fi\u003E{{ editMode ? 'Edit Group' : 'New Group' }}\u003C\u002Fh5\u003E\n  \u003Cbutton class=\"btn-close\" (click)=\"cancel()\"\u003E\u003C\u002Fbutton\u003E\n\u003C\u002Fdiv\u003E\n\u003Cdiv class=\"modal-body\"\u003E\n  \u003Cform\u003E\n    \u003Cdiv class=\"mb-3\"\u003E\n      \u003Clabel class=\"form-label\"\u003EGroup Name *\u003C\u002Flabel\u003E\n      \u003Cinput class=\"form-control\" type=\"text\" [(ngModel)]=\"group.name\" name=\"groupName\" placeholder=\"e.g. Production Servers\" required autofocus\u003E\n    \u003C\u002Fdiv\u003E\n    \u003Cdiv class=\"mb-3\"\u003E\n      \u003Clabel class=\"form-label\"\u003EColor\u003C\u002Flabel\u003E\n      \u003Cdiv class=\"d-flex flex-wrap gap-2 mt-1\"\u003E\n        \u003Cdiv class=\"color-swatch\" *ngFor=\"let c of colorPresets\" [style.background]=\"c\" [class.selected]=\"group.color === c\" (click)=\"group.color = c\" style=\"width:24px;height:24px;border-radius:4px;cursor:pointer;border:2px solid transparent\" [style.border-color]=\"group.color === c ? 'white' : 'transparent'\"\u003E\u003C\u002Fdiv\u003E\n        \u003Cdiv class=\"color-swatch\" [class.selected]=\"!group.color\" (click)=\"group.color = ''\" style=\"width:24px;height:24px;border-radius:4px;cursor:pointer;border:2px solid var(--bs-border-color);background:transparent;display:flex;align-items:center;justify-content:center\"\u003E\u003Ci class=\"fas fa-ban text-secondary\" style=\"font-size:10px\"\u003E\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\n      \u003C\u002Fdiv\u003E\n    \u003C\u002Fdiv\u003E\n  \u003C\u002Fform\u003E\n\u003C\u002Fdiv\u003E\n\u003Cdiv class=\"modal-footer\"\u003E\n  \u003Cbutton class=\"btn btn-secondary\" (click)=\"cancel()\"\u003ECancel\u003C\u002Fbutton\u003E\n  \u003Cbutton class=\"btn btn-primary\" (click)=\"save()\" [disabled]=\"!isValid\"\u003E\u003Ci class=\"fas fa-save me-1\"\u003E\u003C\u002Fi\u003E{{ editMode ? 'Save' : 'Create Group' }}\u003C\u002Fbutton\u003E\n\u003C\u002Fdiv\u003E";;return pug_html;};
module.exports = template;
...
let ConnectionManagerService = class ConnectionManagerService {
    ...
    deleteGroup(id) {
        const hosts = this.config.store.connectionManager.hosts;
        hosts.forEach(h => {
            if (h.groupId === id) {
                h.groupId = null;
            }
    ...
    getHosts() {
        var _a, _b;
        return (_b = (_a = this.config.store.connectionManager) === null || _a === void 0 ? void 0 : _a.hosts) !== null && _b !== void 0 ? _b : [];
    }
    addHost(host) {
    ...
    deleteHost(id) {
        return __awaiter(this, void 0, void 0, function* () {
            this.config.store.connectionManager.hosts =
                this.config.store.connectionManager.hosts.filter((h) => h.id !== id);
            this.config.save();
    ...
    importData(json) {
        ...
        const hosts = (_b = data.hosts) !== null && _b !== void 0 ? _b : [];
    ...
    applySshCredentials(options, creds) {
        ...
        if (creds.authType === 'password') {
            ...
            options.privateKeys = [creds.privateKey];
            if (creds.passphrase) {
...
let HostEditorComponent = class HostEditorComponent {
    ...
    onPrivateKeyFileChange(event) {
        ...
        reader.onload = () => {
            this.credentials.privateKey = reader.result;
        };
    ...
    onJumpPrivateKeyFileChange(event) {
        ...
        const reader = new FileReader();
        reader.onload = () => {
            this.jumpHostCredentials.privateKey = reader.result;
        };
        reader.readAsText(input.files[0]);
    }
...
let MultiExecTabComponent = MultiExecTabComponent_1 = class MultiExecTabComponent extends external_tabby_core_.BaseTabComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const host of this.hosts) {
                ...
                if (!tab)
                    continue;
                this.panes.push({ host, tab, followBottom: true });
    ...
    fitAllPanes() {
        ...
        for (const pane of this.panes) {
            try {
                ...
                // Walk up to find .me-pane-body container
                let containerEl = xtermEl.parentElement;
                while (containerEl && !containerEl.classList.contains('me-pane-body')) {
                    containerEl = containerEl.parentElement;
                }
                if (containerEl) {
                    const toolbar = containerEl.querySelector('terminal-toolbar, .terminal-toolbar');
                    ...
                    if (stableXtermParent) {
                        const nextHeight = Math.max(0, containerEl.clientHeight - toolbarH);
    ...
    get addHostResults() {
        ...
        return this.availableHosts.filter(h => {
            ...
            return h.name.toLowerCase().includes(q) ||
                ((_a = h.host) !== null && _a !== void 0 ? _a : '').toLowerCase().includes(q);
        }).slice(0, 5);
    }
    ...
    addHost(host) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!tab)
                return;
            const pane = { host, tab, followBottom: true };
    ...
    get gridStyle() {
        ...
        return {
            'grid-template-columns': Array(cols).fill('1fr').join(' '),
...
let ConnectionPanelComponent = class ConnectionPanelComponent extends external_tabby_core_.BaseTabComponent {
    ...
    editHost(host, event) {
        return __awaiter(this, void 0, void 0, function* () {
            event.stopPropagation();
            const wasInGroup = !!this.selectedGroup;
            const modal = this.ngbModal.open(HostEditorComponent, { size: 'lg' });
    ...
    buildSshCommand(host) {
        ...
        if (host.type !== 'ssh' || !host.host)
            return `${host.type || 'host'}:${host.host || host.name}`;
        const user = host.username ? `${host.username}@` : '';
        const port = (_b = (_a = host.port) !== null && _a !== void 0 ? _a : 22) !== null && _b !== void 0 ? _b : 22;
        return `ssh ${user}${host.host}${port === 22 ? '' : ` -p ${port}`}`;
    }
    copySshCommands(hosts = this.selectedHosts) {
        const text = hosts.map(h => this.buildSshCommand(h)).join('\n');
        if (!text)
            return;
    ...
    showContextMenu(x, y, host) {
        ...
        divider();
        item('Move to group', 'fas fa-folder-open', () => this.moveSelectedToGroup(hosts));
        item('Export', 'fas fa-file-export', () => this.exportSelected(hosts));
        item('Copy SSH command', 'fas fa-terminal', () => this.copySshCommands(hosts));
        item('Tags', 'fas fa-tags', () => this.editTagsForSelected(hosts));
    ...
    getHostIconColor(_host) {
        return '#ffffff';
    }
    getHostIconBg(host) {
        switch (host.type) {
            case 'ssh': return '#88c0d0';
            case 'telnet': return '#d08770';
            case 'serial': return '#b48ead';
...
let ConnectionManagerModule = class ConnectionManagerModule {
    constructor(app, hotkeys) {
        app.ready$.subscribe(() => {
            app.openNewTab({ type: ConnectionPanelComponent, inputs: {} });
        });
