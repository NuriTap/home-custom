...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":host{display:flex;flex-direction:column;height:100%;min-height:0;overflow:hidden;background:var(--bs-body-bg)}.me-layout{display:flex;flex-direction:column;height:100%;min-height:0;overflow:hidden;position:relative}.me-layout--drag-over{outline:2px dashed var(--bs-primary);outline-offset:-3px}.me-drag-overlay{position:absolute;inset:0;z-index:100;display:flex;align-items:center;justify-content:center;background:rgba(var(--bs-primary-rgb),.15);border:2px dashed var(--bs-primary);font-size:1.1rem;font-weight:600;color:var(--bs-primary);pointer-events:none}.me-drop-hint,.me-loading{flex:1 1 auto;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--bs-secondary);min-height:0}.me-drop-hint{font-size:.85rem;gap:4px;border:2px dashed rgba(255,255,255,.12);margin:12px;border-radius:8px}.me-panes{flex:1 1 auto;display:grid;gap:3px;overflow:hidden;background:#000;min-width:0;min-height:0;width:100%;height:100%;align-items:stretch;align-content:stretch;grid-auto-rows:minmax(0,1fr);grid-auto-columns:minmax(0,1fr)}.me-pane{display:flex;flex-direction:column;overflow:hidden;min-width:0;min-height:0;width:100%;height:100%;border-top:3px solid rgba(255,255,255,.1);transition:border-top-color .15s}.me-pane--active{border-top-color:var(--bs-primary)}.me-pane--drag-over{border-top-color:var(--bs-warning);outline:1px dashed var(--bs-warning)}.me-pane-header{display:flex;align-items:center;gap:5px;padding:2px 6px;background:var(--bs-secondary-bg);font-size:.7rem;color:var(--bs-body-color);flex:0 0 auto;cursor:grab;border-bottom:1px solid rgba(var(--bs-body-color-rgb),.16)}.me-pane-header:active{cursor:grabbing}.me-pane-header i{font-size:.65rem}.me-pane-title{flex:1 1 auto;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.me-pane-close{display:inline-flex;align-items:center;justify-content:center;flex:0 0 20px;width:20px;height:20px;margin-left:4px;background:var(--bs-tertiary-bg);border:1px solid rgba(var(--bs-body-color-rgb),.18);border-radius:4px;color:var(--bs-body-color);cursor:pointer;padding:0;font-size:.68rem;line-height:1;opacity:.9;transition:opacity .15s,background .15s,border-color .15s,color .15s}.me-pane-close:hover{background:rgba(220,53,69,.12);border-color:rgba(220,53,69,.35);color:var(--bs-danger);opacity:1}.me-pane-body{display:contents}.me-pane ::ng-deep ssh-tab,.me-pane ::ng-deep telnet-tab,.me-pane ::ng-deep serial-tab,.me-pane ::ng-deep base-terminal-tab,.me-pane ::ng-deep [class*=-tab]{flex:1 1 auto;min-width:0;min-height:0;width:100%;height:100%;overflow:hidden;display:flex;flex-direction:column}.me-pane ::ng-deep .content{flex:1 1 auto;min-width:0;min-height:0;width:100%;overflow:hidden}.me-pane ::ng-deep terminal-toolbar{flex-shrink:0}.me-pane ::ng-deep .terminal-toolbar-spacer{display:none}.me-cmdbar{flex:0 0 auto;border-top:1px solid rgba(255,255,255,.1);background:var(--bs-body-bg);padding:8px 12px;display:flex;flex-direction:column;gap:7px}.me-cmdbar-top{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.me-cmdbar-label{font-size:.75rem;font-weight:700;color:var(--bs-secondary);text-transform:uppercase;letter-spacing:.04em;white-space:nowrap;flex-shrink:0}.me-chips{display:flex;flex-wrap:wrap;gap:4px;flex:1 1 auto;min-width:0}.me-chip-wrap{display:inline-flex;align-items:center}.me-chip-wrap:hover .me-chip-remove{opacity:1;width:12px;margin-left:4px}.me-chip-remove{background:var(--bs-secondary-bg);border:1px solid rgba(var(--bs-body-color-rgb),.16);border-radius:4px;color:var(--bs-body-color);cursor:pointer;padding:0;font-size:.58rem;line-height:1;opacity:.9;width:14px;overflow:hidden;transition:opacity .15s,width .15s,color .15s,background .15s;margin-left:4px}.me-chip-remove:hover{color:var(--bs-danger);opacity:1}.me-chip{display:inline-flex;align-items:center;gap:4px;padding:3px 9px;border-radius:100px;font-size:.75rem;font-weight:650;border:1px solid rgba(var(--bs-body-color-rgb),.22);background:var(--bs-secondary-bg);color:var(--bs-body-color);opacity:.95;cursor:pointer;transition:all .15s;user-select:none}.me-chip i{font-size:.6rem}.me-chip--on{border-color:var(--bs-primary);background:rgba(var(--bs-primary-rgb),.24);color:var(--bs-body-color);opacity:1;box-shadow:0 0 0 2px rgba(var(--bs-primary-rgb),.14)}.me-chip:hover:not(.me-chip--on){border-color:rgba(var(--bs-primary-rgb),.5);color:var(--bs-primary);opacity:1}.me-addhost-wrap{position:relative;flex-shrink:0}.me-addhost-input-wrap{display:flex;align-items:center;gap:5px;background:var(--bs-secondary-bg);border:1px solid rgba(var(--bs-body-color-rgb),.22);border-radius:4px;padding:2px 7px;transition:border-color .15s,box-shadow .15s}.me-addhost-input-wrap:focus-within{border-color:var(--bs-primary)}.me-addhost-icon{font-size:.65rem;color:var(--bs-secondary);flex-shrink:0}.me-addhost-input{background:none;border:none;outline:none;color:var(--bs-body-color);font-size:.72rem;font-weight:600;width:90px;min-width:0}.me-addhost-input::placeholder{color:var(--bs-secondary)}.me-addhost-clear{font-size:.6rem;color:var(--bs-secondary);cursor:pointer;flex-shrink:0;transition:color .1s}.me-addhost-clear:hover{color:var(--bs-body-color)}.me-addhost-results{position:absolute;bottom:calc(100% + 6px);right:0;min-width:210px;max-height:240px;overflow-y:auto;background:var(--bs-body-bg);border:1px solid rgba(255,255,255,.15);border-radius:6px;box-shadow:0 -6px 20px rgba(0,0,0,.45);z-index:200;padding:4px 0}.me-addhost-item{display:flex;align-items:center;width:100%;padding:5px 12px;background:none;border:none;color:var(--bs-body-color);font-size:.8rem;text-align:left;cursor:pointer;transition:background .1s,color .1s;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.me-addhost-item:hover,.me-addhost-item--active{background:rgba(var(--bs-primary-rgb),.15);color:var(--bs-primary)}.me-addhost-empty{padding:6px 12px;font-size:.75rem;color:var(--bs-secondary)}.me-btn{padding:2px 9px;border-radius:4px;font-size:.72rem;font-weight:650;border:1px solid rgba(var(--bs-body-color-rgb),.24);background:var(--bs-secondary-bg);color:var(--bs-body-color);opacity:.95;cursor:pointer;white-space:nowrap;transition:all .15s}.me-btn:hover{background:var(--bs-primary);border-color:var(--bs-primary);color:#fff;opacity:1}.me-broadcast-row{display:flex;align-items:center;gap:7px;padding:5px 10px;border-radius:5px;border:1px solid rgba(var(--bs-body-color-rgb),.22);background:var(--bs-secondary-bg);color:var(--bs-body-color);font-size:.78rem;cursor:text;outline:none;transition:border-color .15s,background .15s,box-shadow .15s;user-select:none}.me-broadcast-row:focus,.me-broadcast-row--active{border-color:var(--bs-primary);background:rgba(var(--bs-primary-rgb),.12);color:var(--bs-body-color);box-shadow:0 0 0 2px rgba(var(--bs-primary-rgb),.14)}.me-broadcast-row--empty{opacity:.5;cursor:default}.me-broadcast-icon{font-size:.72rem;flex-shrink:0}.me-broadcast-hint{font-style:italic}.me-broadcast-typing{display:flex;align-items:center;gap:4px;color:var(--bs-primary);font-weight:600}.me-broadcast-cursor{animation:me-blink 1s step-end infinite}@keyframes me-blink{0%,100%{opacity:1}50%{opacity:0}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
